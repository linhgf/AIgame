...
public class Vehicle : MonoBehaviour {
	...
	public float maxForce = 100;//最大阻力
	protected float sqrMaxSpeed;//最大速度的平方
	public float mass = 1;//质量
	public Vector3 velocity;
	public float damping = 0.9f;
	public float computeInterval = 0.05f;
	public bool isPlanar = true;

	private Vector3 steeringForce;//操控力
	protected Vector3 acceleration;//加速度
