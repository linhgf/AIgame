...
public class GenerateBotsForFollower : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < botCount; i++)
        {
            ...
            bot.GetComponent<EvadeController>().leader = gameObject;
            bot.GetComponent <SteeringForLeaderFollowing>().leader = gameObject;
        }
    }
